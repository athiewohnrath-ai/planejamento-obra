...
function gClosePop(){
  ...
  gClosePopForce();
    ...
    try{
      ...
      if(_ht){_ht.innerHTML='Planejamento <em>de Obra</em>'+(_nm?'<span style="font-family:var(--body);font-size:11px;font-weight:400;color:rgba(255,255,255,.5);margin-left:10px;">'+_nm+'</span>':'')+(_st==='frozen'?'<span style="font-size:9px;font-weight:700;padding:2px 8px;border-radius:10px;background:rgba(0,185,80,.2);color:#00B950;border:1px solid rgba(0,185,80,.35);margin-left:10px;">❄ Congelado</span>':'');}
