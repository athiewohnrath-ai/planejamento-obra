...
function gBuildAprovaHtml(t){
  ...
  var sid=t.subId;
  return '<div style="margin-top:12px;border-top:1px solid #EEF0F4;padding-top:12px;">'
    ...
    +'<input type="checkbox" id="pop-aprova-chk" '+(ac.ativo?'checked ':'')+' onchange="gPopAprovaChange(\''+sid+'\')" style="accent-color:#D4A017;width:13px;height:13px;cursor:pointer;">'
    +'<span style="font-size:11px;color:#3A4A5A;">Requer aprovação</span></label>'
    +'<label style="display:flex;align-items:center;gap:7px;">'
    +'<span style="font-size:9px;font-weight:700;color:#8A95A8;">Dias</span>'
    +'<input type="number" id="pop-aprova-dias" value="'+ac.dias+'" min="1" max="10" onchange="gPopAprovaChange(\''+sid+'\')" style="width:44px;padding:3px 5px;border:1px solid #C8CDD8;border-radius:4px;font-size:12px;text-align:center;" '+(ac.ativo?'':'disabled')+'>'
    +'</label></div>';
}
