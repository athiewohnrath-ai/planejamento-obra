...
function renderObraFases(){
  ...
  // Inicializar dias de aprovação com 0 se não tiverem override explícito
  if(_alocDs&&_alocDs.subId){
    var _aprDias=getDiasAprovacao(_alocDs.subId);
    _aprDias.forEach(function(_dk){
      if(void 0===_alocOverride[_dk]){_alocOverride[_dk]=0;}
    });
