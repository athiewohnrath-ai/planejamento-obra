...
(function(){
  ...
  if(poDays.length){
    ...
    var newDays=poDays.filter(function(x){return!seen.has(G.fmtISO(x.date));}).sort(function(a,b){return G.ms(a.date)-G.ms(b.date);});
    newDays.forEach(function(x){r.unshift(x);});
  }
})();
