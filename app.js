...
(function(obraFase, obraFaseIdx){
  ...
  // Sidebar header
  r.push('<div data-po-open="'+obraFaseIdx+'" style="height:'+(G.ROW_H+12)+'px;background:'+cm+';display:flex;align-items:center;padding:0 6px 0 12px;border-bottom:1px solid #C8B890;border-right:2px solid #C0C8D4;font-size:11px;font-weight:700;color:#fff;text-transform:uppercase;letter-spacing:.06em;gap:4px;cursor:pointer;"><span style="width:5px;height:5px;border-radius:1px;background:rgba(255,255,255,.4);flex-shrink:0;"></span><span style="flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">Pré-Obra'+(gSt.obraFases.length>1?' F'+(obraFaseIdx+1):'')+' · '+du+' DU</span><span style="font-size:9px;opacity:.6;"> ✏</span></div>');
