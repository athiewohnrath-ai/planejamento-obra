...
(function(){
  ...
  console.log('[PRE-OBRA] faseIdx='+_poFaseIdx+' pc='+JSON.stringify(pc)+' s='+s);
  if(!pc||!pc.ativo){console.log('[PRE-OBRA] inativo, pulando');return;}
  var du=pc.du||5;
