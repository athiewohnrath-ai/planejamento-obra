...
(function(){
  ...
  var poDragPayload=encodeURIComponent(JSON.stringify({type:'preObra',faseIdx:obraFaseIdx}));
  i.push(
    ...
    '<div data-drag="'+poDragPayload+'" style="position:absolute;top:8px;left:'+xi+'px;height:'+G.ROW_H+'px;width:'+xw+'px;'+
    'background:'+cm+';border-radius:3px;display:flex;align-items:center;justify-content:center;overflow:hidden;cursor:ew-resize;">'+
...
(function(obraFase, obraFaseIdx){
  ...
  r.push(
    ...
    '<span style="width:5px;height:5px;border-radius:1px;background:'+cm+';flex-shrink:0;"></span>'+
    '<span style="flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">Pré-Obra'+
    (gSt.obraFases.length>1?' F'+(obraFaseIdx+1):'')+
    '</span>'+(lbl?'<span style="font-size:8px;padding:1px 5px;border-radius:8px;background:rgba(255,255,255,.18);color:#fff;">'+lbl+'</span>':'')+
    '</div>'
  );
