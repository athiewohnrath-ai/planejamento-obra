// Planejamento de Obra A|W — v6.03.14
...
function _congAplicarVisual(){
  ...
  if(inner){
    inner.style.filter=frozen?'grayscale(1) brightness(1.28) opacity(.92)':'';
