...
const savedBg=ESTADO.cfg&&ESTADO.cfg.aprovaBgColor?ESTADO.cfg.aprovaBgColor:'transparent';
aprBgColor.type='color';
aprBgColor.value=savedBg==='transparent'?'#3A6FBE':savedBg;
