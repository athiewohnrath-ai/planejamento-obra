...
(function(obraFase, obraFaseIdx){
  ...
  console.log("[PO] idx="+obraFaseIdx+" ativo="+(pc&&pc.ativo)+" tpl="+(pc&&pc.templateId)+" du="+(pc&&pc.du));
  ...
  var barHtml=gBar(xi,xw,G.ROW_H,cm,ini,fim,null,payload,true);
  i.push(
  ...
  if(tpl){
    ...
    ds.forEach(function(pd,pi){
      ...
      var xiC=Math.max(0,xi),xwC=xw+Math.min(0,xi);
      r.push(
      ...
      i.push(
        ...
        (xwC>0?'<div style="position:absolute;top:3px;left:'+xiC+'px;height:'+(G.SUB_H-6)+'px;width:'+xwC+'px;'+
